...
/**
 * Simple test client for Vehicle Edge Runtime (Docker)
 * Tests basic WebSocket communication with Docker container
 */

import WebSocket from 'ws';

const RUNTIME_URL = 'ws://localhost:3006/runtime';

async function testBasicConnectivity() {
    console.log('Testing Vehicle Edge Runtime Docker connectivity...');
    ...
    return new Promise((resolve, reject) => {
        ...
        ws.on('open', () => {
            console.log('✓ Connected to Vehicle Edge Runtime (Docker)');
            testResults.passed++;
            ...
            try {
                ...
                if (message.type === 'connection_established') {
                    ...
                    ws.send(JSON.stringify({
                        type: 'register_kit',
                        kitInfo: {
                            name: 'Test Docker Kit',
                            version: '1.0.0',
                            description: 'Test kit from Docker test client'
                        }
                    }));
...
async function main() {
    console.log('Vehicle Edge Runtime Docker Test Client');
    console.log('==========================================');
