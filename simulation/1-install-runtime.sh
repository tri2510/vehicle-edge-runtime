...
echo "  Start runtime: docker exec -it $CONTAINER su pi -c 'cd /home/pi/vehicle-edge-runtime/workspace && npm start'"
echo "  Access shell: docker exec -it $CONTAINER su pi -c bash"
echo "  Check npm version: docker exec $CONTAINER su pi -c npm --version"